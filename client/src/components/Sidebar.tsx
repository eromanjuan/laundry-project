...
export function Sidebar() {
  return (
    <aside className="hidden w-72 flex-col border-r border-blue-100 bg-slate-950 text-slate-100 lg:flex">
      <div className="border-b border-blue-900/60 px-6 py-6">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Offline-ready laundry management dashboard
        </p>
      </div>
      ...
      <div className="border-t border-blue-900/60 px-6 py-5">
        <div className="rounded-2xl border border-blue-900/60 bg-blue-950/70 p-4">
          <p className="text-xs uppercase tracking-[0.3em] text-blue-300">Status</p>
          <p className="mt-2 text-sm font-semibold text-white">All systems online</p>
          <p className="mt-1 text-xs text-slate-400">Ready for daily operations</p>
        </div>
      </div>
    </aside>
  )
